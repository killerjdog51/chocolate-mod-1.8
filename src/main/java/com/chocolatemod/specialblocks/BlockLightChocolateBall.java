...
public class BlockLightChocolateBall extends Block{
	
    public static final PropertyInteger LEVEL = PropertyInteger.create("stage", 0, 5);
	private int TickRate;

	public BlockLightChocolateBall() {
		super(Material.rock);
	    ...
	    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
	    	...
	    	if (worldIn.isRemote) {
				...
				if (itemstack == null) {
                    ...
                    if (meta == 5) {
						ItemStack itemstack2 = new ItemStack(ChocolateItems.chocolateball, 4, 2);
						...
						worldIn.setBlockState(pos, SpecialBlocks.BallMold.getDefaultState());
						playerIn.addStat(Achievements.achievementChocolateBall, 1);
